...
const ORG_PEOPLE = {
  ...
  // 안전보건관리담당자
  '박재걸 공장장':         { type:'담당자',   role:'안전보건관리담당자',                 site:'전사' },
...
const ORG_TREE = [
  ...
  { id:'박재걸 공장장', label:'박재걸 공장장', sub:'안전보건관리담당자', level:1, parent:'대표이사' },
  { id:'박제성 부장', label:'박제성 부장', sub:'안전보건관리담당자 · 본사 소방/전기', level:1, parent:'대표이사' },
  { id:'김민수 부장', label:'김민수 부장', sub:'관리감독자 (사출)', level:2, parent:'박재걸 공장장' },
  { id:'양춘향 과장', label:'양춘향 과장', sub:'관리감독자 (도장)', level:2, parent:'박재걸 공장장' },
  { id:'임문호 이사', label:'임문호 이사', sub:'관리감독자 (조립) · 화성공장 환경/소방/전기', level:2, parent:'박재걸 공장장' },
...
const SAFETY_TASKS = [
  ...
  { id:12, group:'안전', name:'특별안전교육', vendor:'위탁/자체', period:'해당시', periodCode:'asNeeded',
    ...
    assignedTo:['박재걸 공장장','박제성 부장'] },
  { id:13, group:'안전', name:'근골격계질환예방', vendor:'자체시행', period:'1회/3년 (8월 이내 실시)', periodCode:'triennial', dueMonth:8,
    content:'근골격계유해요인조사 후 결과서 작성 및 보관 (8월 이내 실시)',
  ...
  { id:14, group:'안전', name:'보호구 지급', vendor:'자체시행', period:'1회/격월', periodCode:'bimonthlyOdd',
    ...
    assignedTo:['박재걸 공장장','박제성 부장'] },
  { id:15, group:'안전', name:'산업안전보건위원회', vendor:'자체시행', period:'1회/분기', periodCode:'quarterly',
    content:'분기 1회 산업안전보건위원회 실시, 안전관리자/보건관리자 위임장 확보',
  ...
  { id:18, group:'안전', name:'화학물질통계', vendor:'자체시행', period:'1회/2년', periodCode:'biennial', dueMonth:1,
    content:'화학물질통계조사표 작성 제출 (본사: 비대상, 화성공장: 대상)\n· 26년 통계자료 → 27년 6월 30일까지 신고\n· 28년 통계자료 → 29년 6월 30일까지 신고 (1회/2년)',
  ...
  { id:20, group:'안전', name:'안전보건선포식', vendor:'자체시행', period:'1회/년', periodCode:'yearly', dueMonth:1,
    ...
    assignedTo:['박재걸 공장장','박제성 부장'] },
  { id:21, group:'안전', name:'업무평가', vendor:'자체시행', period:'1회/반기', periodCode:'semiannual',
    content:'안전보건관리책임자, 관리감독자 업무 평가\n· 상반기 평가 7월 진행\n· 하반기 평가 익년 1월 진행 (총 연 2회)',
...
// ──────────────────────────────────────────────────────────
// 5. 관리감독자 9개 책임 항목 (업무분장 시트 A1~C11)
//    김민수·양춘향·임문호 박스 클릭 시 표시되는 별도 리스트
// ──────────────────────────────────────────────────────────
const SUPERVISOR_TASKS = [
  { id:'S1', name:'위험성평가',         content:'당일 작업에 대한 유해, 위험요인을 파악하고 근로자에게 공유, 개선조치 시행 참여' },
  { id:'S2', name:'보호구 착용',        content:'근로자의 작업복, 보호구 및 방호장치의 점검과 그 착용, 사용에 관한 교육, 지도' },
  { id:'S3', name:'기계, 설비 점검',    content:'기계, 기구 및 방호장치 이상 유무 확인' },
  { id:'S4', name:'작업장 환경',        content:'정리정돈, 통로 확보, 조명 상태' },
  { id:'S5', name:'안전보건교육',       content:'작업전 TBM(Tool Box Meeting)을 통한 안전수칙 교육' },
  { id:'S6', name:'작업수칙 준수',      content:'작업절차(SOP) 준수 여부 확인' },
  { id:'S7', name:'물질안전보건자료',   content:'화학물 취급 시 MSDS 교육 및 용기 표시 확인' },
  { id:'S8', name:'비상조치',           content:'작업장 내 위험 상황 발생 여부 확인(즉시 작업중지), 산업재해 보고 및 응급조치' },
  { id:'S9', name:'당일 개선 사항',     content:'당일 유해, 위험요인에 대한 개선' }
];

// 인물 → 담당 업무 목록
//   박재걸 공장장 / 박제성 부장 → 33개 안전보건 업무 (안전보건관리담당자)
//   김민수 부장 / 양춘향 과장 / 임문호 이사 → 9개 관리감독자 책임 항목
//   그 외 (대표이사, 협의체, 외부 위탁, 전 근로자) → 빈 리스트
function tasksByPerson(personId){
  if(personId === '박재걸 공장장' || personId === '박제성 부장'){
    return SAFETY_TASKS;
  }
  if(['김민수 부장','양춘향 과장','임문호 이사'].includes(personId)){
